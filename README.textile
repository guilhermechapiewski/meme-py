...
Check it out some simple and cool examples (for more please check "examples/examples.py":http://github.com/guilhermechapiewski/meme-py/blob/master/examples/examples.py file):
