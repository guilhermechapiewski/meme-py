...
*Please* follow "PEP-8":http://www.python.org/dev/peps/pep-0008/ rules and include unit tests!
...
If you want to contribute and still have some questions or if you are still having trouble using *meme-py*, join the "*meme-dev* group ant Yahoo! Groups":http://tech.groups.yahoo.com/group/meme-dev/ where you will find other developers that use Yahoo! Meme and APIs for many programming languages.
